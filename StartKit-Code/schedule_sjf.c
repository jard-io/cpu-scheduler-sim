...
// Shortest job first - sort using a stable sorting algorithm, meaning if two are equal, then the first that comes up is put first
...
int main(int argc, char* argv[]) {
    ...
    int arr_size = sizeof(tasks) / sizeof(tasks[0]);
